          ...
          <div className="flex flex-col size-full bg-white">
            ...
            <div className="px-5 pt-[env(safe-area-inset-top)]">
              <div className="flex items-center gap-3 h-14">
                ...
                <h1 className="text-[18px] font-semibold text-gray-900">Clean & Earn History</h1>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-5 pb-8">
              {!user ? (
                <div className="flex flex-col items-center pt-20">
                  ...
                  <p className="text-gray-400 text-[14px]">Sign in to view your history</p>
                  <button
                ...
                <div className="flex flex-col items-center pt-20">
                  <Leaf className="size-12 text-gray-200 mb-3" />
                  <p className="text-[16px] font-semibold text-gray-700 mb-1">No submissions yet</p>
                  <p className="text-gray-400 text-[13px] text-center px-8">Start your first Clean & Earn session to see your history here.</p>
                  <button
                  ...
                  {submissions.map((sub) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full flex items-center gap-3 bg-white border border-gray-100 rounded-2xl p-4 active:bg-gray-50 transition-colors text-left shadow-sm"
                      >
